...
class ChristmasLights:
    ...
    TREE_COLORS = [Color(0, 255, 0), Color(0, 128, 128), Color(255, 0, 0), Color(255, 255, 255), Color(255, 0, 255)]
    STAR_COLORS = [Color(128, 128, 0), Color(255, 255, 255), Color(0, 255, 0), Color(255, 0, 0), Color(0, 0, 255)]
